<template>
  <nav class="fixed w-full p-6 bg-gray-50 border shadow-xl sticky">
    <div class="flex items-center justify-between">
      ...
      <div class="hidden md:block">
        <ul class="flex space-x-8 text-sm font-sans">
          ...
          <li><a href="#" class="">Recruit</a></li>
          <li><a href="#" class="">Apply</a></li>
          <li><a href="#" class="">Chat</a></li>
          <li><a href="#" class="">About</a></li>
          <li><a href="#" class="cta bg-blue-500 hover:bg-blue-600 px-3 py-2 rounded text-white font-semibold">Profile</a></li>
        </ul>
      </div>
